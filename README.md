...
- 병원에 설치된 키오스크의 전자 문진표 작성 기능 중 일부를 C# .NET Framework 및 EntityFramework를 이용해 구현하였다.
...
![기본정보입력](./Document/고객/1_기본정보_입력.jpg)

- 확인 버튼을 누르면 정보가 입력되었는지 판단하고 다음 창으로 넘어간다.

### 2. 추가 정보 입력

![추가정보입력](./Document/고객/2_추가정보_입력.jpg)
![추가정보입력기입력자](./Document/고객/2-1_추가정보_입력_기입력자.jpg)
...
![진료과선택](./Document/고객/3_진료과_선택.jpg)

- 진료과를 선택하면 선택한 진료과에 해당하는 문진표 화면으로 전환된다.

### 4. 문진표 작성

![문진표작성](./Document/고객/4_문진표_작성.jpg)
![문진표작성_하단](./Document/고객/4-1_문진표_작성_하단부.jpg)
...
![직원로그인](./Document/직원/1_직원_로그인.jpg)
![비밀번호변경](./Document/직원/1-1_비밀번호_변경.jpg)

- 확인 버튼을 누르면 정보가 입력되었는지 판단하고 다음 창으로 넘어간다.

### 2. 작업 선택

![작업선택병원장](./Document/직원/2-1_작업_선택(병원장).jpg)
![작업선택의사](./Document/직원/2-2_작업_선택(의사).jpg)
![작업선택간호사](./Document/직원/2-3_작업_선택(간호사).jpg)
...
![문진표관리](./Document/직원/3_문진표_관리.jpg)
![문진표관리진단내용작성](./Document/직원/3-1_문진표_진단내용_작성.jpg)
![문진표관리진단내용비활성](./Document/직원/3-2_문진표_진단내용_비활성.jpg)
...
![문진표질문관리](./Document/직원/4_문진표_질문_관리.jpg)
![문진표질문관리추가](./Document/직원/4-1_질문_추가_및_수정(추가버튼).jpg)
![문진표질문관리수정](./Document/직원/4-2_질문_추가_및_수정(수정버튼).jpg)

- 문진표 질문의 추가, 수정, 삭제가 가능하다
- 질문의 문항 유형은 주관식, 객관식, 객관석(다중선택)이다
- 수정 후 일괄 저장울 눌러야 데이터베이스에 저장된다

### 5. 환자 정보 관리

![환자정보관리](./Document/직원/5_환자_정보_관리.jpg)
![환자정보관리수정](./Document/직원/5-1_환자_정보_수정.jpg)
...
![직원정보관리](./Document/직원/6_직원_정보_관리.jpg)
![직원정보관리추가](./Document/직원/6-1_직원_정보_추가_및_수정(추가버튼).jpg)
![직원정보관리수정](./Document/직원/6-2_직원_정보_추가_및_수정(수정버튼).jpg)
...
- 확인 결과, 문진표 관리 뒤로가기 버튼 이벤트 활성 시 접속중인 직원의 정보가 전달이 되지 않음

## 결과
문진표 관리 뒤로가기 버튼 이벤트 활성 시, 이벤트 핸들러를 통해 접속중인 직원의 정보가 전달되도록 변경함
또한, 문진표 질문 관리, 직원 관리, 고객 관리의 각 버튼 이벤트 핸들러 구문에 접속중인 직원의 정보가 전달되도록 수정.
